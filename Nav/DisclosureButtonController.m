...
- (void)viewDidLoad
{
    NSArray *array = [[NSArray alloc] initWithObjects:@"Toy Story", @"A Bug's Life", @"Toy Story 2", @"Montsers, Inc", @"Finding Nemo", @"The Incredibles", @"Cars", @"Ratatouille", @"WALL-E", @"Up", @"Toy Story 2", @"Cars 2", @"Brave", nil];
    self.list = array;
    // [array release];
    [super viewDidLoad];
}
